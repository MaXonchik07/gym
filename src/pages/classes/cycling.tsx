...
function Cycling() {
    ...
    const classData = {
        id: "cycling",
        name: "Велотренажер",
        description: "Энергичная велотренировка с переменной нагрузкой для сильных ног и мощного кардио.",
        duration: "50 мин",
        capacity: "15",
        difficulty: "Intermediate",
        schedule: [
            { day: "Понедельник", time: "15:00", instructor: "Джессика Мартинес" },
            { day: "Среда", time: "15:00", instructor: "Джессика Мартинес" },
            { day: "Пятница", time: "15:00", instructor: "Джессика Мартинес" },
        ],
        instructor: "Джессика Мартинес",
        benefits: [
            "Сжигание калорий",
            "Укрепление ног",
    ...
    return (
        <>
            ...
            <div className="classBlock1">
                <div className="classOverlay cyclingIMG">
