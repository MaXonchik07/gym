...
function Fullbody() {
    ...
    const classData = {
        ...
        description: "Интенсивная силовая тренировка на все тело с использованием гантелей, гирь и собственного веса для максимальной отдачи.",
        duration: "55 мин",
        capacity: "14",
        difficulty: "Advanced",
        schedule: [
            { day: "Понедельник", time: "19:30", instructor: "Максим Петров" },
            { day: "Среда", time: "19:30", instructor: "Максим Петров" },
            { day: "Пятница", time: "19:30", instructor: "Максим Петров" },
        ],
    ...
    return (
        <>
            ...
            <div className="classBlock1">
                <div className="classOverlay fullbodyIMG">
