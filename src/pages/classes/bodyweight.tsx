...
function Bodyweight() {
    ...
    const classData = {
        id: "bodyweight",
        name: "Тренировка с собственным весом",
        description: "Силовая тренировка только с собственным весом: отжимания, подтягивания, приседания и статические удержания.",
        duration: "45 мин",
        capacity: "20",
        difficulty: "Beginner",
        schedule: [
            { day: "Вторник", time: "18:00", instructor: "Елена Смирнова" },
            { day: "Четверг", time: "18:00", instructor: "Елена Смирнова" },
            { day: "Суббота", time: "18:00", instructor: "Елена Смирнова" },
        ],
    ...
    return (
        <>
            ...
            <div className="classBlock1">
                <div className="classOverlay bodyweightIMG">
