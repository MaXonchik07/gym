...
function AcroYoga() {
    ...
    const classData = {
        id: "acro-yoga",
        name: "Акробатическая йога",
        description: "Парная практика, сочетающая элементы йоги, акробатики и тайского массажа для доверия и баланса.",
        duration: "75 мин",
        capacity: "10",
        difficulty: "Intermediate",
        schedule: [
            { day: "Четверг", time: "15:00", instructor: "Анна Иванова" },
            { day: "Пятница", time: "16:00", instructor: "Анна Иванова" },
            { day: "Суббота", time: "18:00", instructor: "Анна Иванова" },
        ],
    ...
    return (
        <>
            ...
            <div className="classBlock1">
                <div className="classOverlay acroYogaIMG">
