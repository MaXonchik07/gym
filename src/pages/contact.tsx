                    ...
                    <div className="col row gx-0">
                        ...
                        <div className="oftenQuestions">
                            ...
                            <div className="queBlock">
                                ...
                                <div className="queText">Да, мы предлагаем семейную скидку 10% для двух и более членов семьи, оформляющих абонементы вместе. Для получения скидки необходимо обратиться на стойку администратора, чтобы подтвердить, что вы являетесь членами одной семьи.</div>
                            </div>
                        </div>
                    </div>
                </div>
